		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "PraticaModel1",
									"targetURL": "#mentoriafiorikazpraticamodelbfs-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"mentoriafiorikazpraticamodelbfs-display": {
								"semanticObject": "mentoriafiorikazpraticamodelbfs",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=mentoria.fiori.ka.zpraticamodelbfs",
									"url": sap.ui.require.toUrl("mentoria/fiori/ka/zpraticamodelbfs")
								}
							}
						}
					}
