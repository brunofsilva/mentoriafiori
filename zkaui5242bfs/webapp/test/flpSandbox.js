		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "FirstProject",
									"targetURL": "#mentoriafiorikazkaui5242bfs-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"mentoriafiorikazkaui5242bfs-display": {
								"semanticObject": "mentoriafiorikazkaui5242bfs",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=mentoria.fiori.ka.zkaui5242bfs",
									"url": sap.ui.require.toUrl("mentoria/fiori/ka/zkaui5242bfs")
								}
							}
						}
					}
